package io.factorialsystems.faspetclinic.web.controllers;
...
class OwnerControllerTest {
    ...
    void setUp() {
        owners = new HashSet<>();
        owners.add(Owner.builder().id(1l).firstName("Adebola").lastName("Omoboya").build());
        owners.add(Owner.builder().id(2l).firstName("Foluke").lastName("Omoboya").build());
